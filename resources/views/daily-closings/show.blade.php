    ...
    <div class="row mb-3">
        <div class="col">
            <a href="{{ route('reports.export-pdf', ['date_from' => $dailyClosing->closing_date->toDateString(), 'date_to' => $dailyClosing->closing_date->toDateString()]) }}"
                target="_blank" class="btn btn-secondary" style="font-size:1em; padding: 0.35em 0.7em;">
                <i class="fas fa-print mr-1"></i> Imprimir Reporte PDF
            </a>
            <a href="{{ route('daily-closings.index') }}" class="btn btn-light ml-2" style="font-size:1em; padding: 0.35em 0.7em;">
