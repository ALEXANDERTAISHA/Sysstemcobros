            ...
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        @php
                            $hasTodayInitialCash = \App\Models\CashBoxInitial::whereDate('date', today()->toDateString())->exists();
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('reports.index') }}"
                                        class="nav-link {{ request()->routeIs('reports.*') ? 'active' : '' }} {{ $operationLockedClass }}"
                                        title="{{ $operationLockedTitle }}"
                                        aria-disabled="{{ $hasTodayInitialCash ? 'false' : 'true' }}">
